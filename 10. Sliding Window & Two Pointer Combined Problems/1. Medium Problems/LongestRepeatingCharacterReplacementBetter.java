 ...
 *  We use a sliding window approach with two pointers (left and right) to maintain a window of characters in the string.
 ...
 *  If it does, we move the left pointer to the right, decrementing the count of the character at the left pointer in the frequency array and recalculating the maximum frequency.
